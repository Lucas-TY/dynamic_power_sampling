...
# Runs power_samp_alpaca.py locally without sbatch/salloc.
# Usage:
#   ./power_samp_alpaca_local.sh         # run all shard/seed combos sequentially
#   ./power_samp_alpaca_local.sh 5 0     # run a single shard/seed
# Environment overrides:
#   CONDA_ENV (default: cloudspace)
#   NUM_SHARDS (default: 14)
#   NUM_SEEDS (default: 1)
