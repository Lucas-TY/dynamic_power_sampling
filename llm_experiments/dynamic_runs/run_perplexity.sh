...
# Run any local sampling script with perplexity-based dynamic stopping.
# Usage: ./run_perplexity.sh [path_to_local_script] [script_args...]
...
export DYNAMIC_METRIC="perplexity"
export ENTROPY_THRESHOLD="${ENTROPY_THRESHOLD:-1.0}"
export PERPLEXITY_THRESHOLD="${PERPLEXITY_THRESHOLD:-2.5}"
